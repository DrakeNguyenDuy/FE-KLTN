...
//     const userLoading = useSelector((state) => state.alumusAuth.loading);
//     const cvLoading = useSelector((state) => state.cv.isLoading);
//     const applyLoading = useSelector((state) => state.recruitment.applyLoading);
//     const followLoading = useSelector((state) => state.job.followLoading);
...
//     return userLoading || jobDetailIsLoading || cvLoading || applyLoading || followLoading ? (
//         <Loading />
//     ) : (
...
//                         </CustomButton> */}
//                         {console.log('jobDetails', jobDetails?.applied)}
...
import RequireLogin from '~/components/common/RequireLogin/RequireLogin';
    ...
    return userLoading || jobDetailIsLoading || cvLoading || applyLoading || followLoading ? (
        ...
        <>
            ...
            <JobDetailContent
                ...
                hideBreadcrumb={true}
                hideButton={true}
                handleApply={handleOpenModal}
                handleFollow={handleLikeJob}
                handleUnfollow={handleLikeJob}
                callJob={false}
            />
        </>
    );
